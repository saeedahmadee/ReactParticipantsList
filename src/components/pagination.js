		...
		return (
			<Table.Row>
				<Table.HeaderCell colSpan="8">
					<Label>
						Total pages:
						<Label.Detail>{this.props.totalPages}</Label.Detail>
					</Label>
					<Menu floated="right" pagination borderless>
						<Menu.Item as="a" icon onClick={this.begin} disabled={this.props.currentPage === 0}>
							<Icon name="angle double left" />
						</Menu.Item>
						<Menu.Item as="a" icon onClick={this.prev} disabled={this.props.currentPage === 0}>
